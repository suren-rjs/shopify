# Wesellvelli Jewelry – Full Stack eCommerce Web Application + Admin Panel


![Wesellvelli Image Banner](https://i.ibb.co/jVzQLfX/sofy-jewelry.png)

Wesellvelli Jewelry is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
- **Authentication:** Wesellvelli includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Typescript + Next.js App Directory:** Wesellvelli leverages TypeScript in combination with Next.js, enhancing code reliability and maintainability.
...
- **Responsive Layout Design:** Wesellvelli is fully responsive across all devices, providing a seamless experience for your customers.
...
- **Flexible and Multi-Purpose:** Wesellvelli is versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** Wesellvelli provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
To get started with Wesellvelli, follow these steps:
...
[Wesellvelli Client Side Live Link](https://shofy-jewelry-ecommerce.vercel.app)

## Server Side Live Link

[Wesellvelli Server Side Live Link](https://shofy-backend-seven.vercel.app)

## Client Side Repo

[Wesellvelli Client Side Repo](https://github.com/Hamed-Hasan/shofy-Jewelry-ecommerce-client.git)

## Server Side Repo

[Wesellvelli Server Side Repo](https://github.com/Hamed-Hasan/shofy-Jewelry-ecommerce-backend.git)
...
## Thank You for Choosing Wesellvelli!

We hope you find Wesellvelli to be a powerful and effective solution for your eCommerce needs. Should you encounter
